...
export const adminTables: Record<string, TableConfig> = {
  ...
  publications: {
    ...
    fields: [
      ...
      { name: "authors", label: "Penulis (pisahkan koma)", type: "text", required: true },
      ...
      { name: "journal_name", label: "Nama Jurnal / Prosiding", type: "text" },
      { name: "publisher", label: "Penerbit", type: "text" },
      { name: "volume", label: "Volume", type: "text" },
      { name: "issue", label: "Issue / Nomor", type: "text" },
      { name: "pages", label: "Halaman (contoh: 123-135)", type: "text" },
      { name: "issn", label: "ISSN", type: "text" },
      { name: "doi", label: "DOI (contoh: 10.1234/abcd.2026.001)", type: "text" },
      { name: "abstract", label: "Abstract", type: "textarea" },
      { name: "keywords", label: "Keywords", type: "tags" },
      { name: "url", label: "Link Tambahan (opsional, selain DOI)", type: "text" },
